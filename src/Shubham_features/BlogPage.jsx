    ...
    return (
      <div className="mt-20 flex flex-col md:flex-row bg-zinc-950 text-white">
          ...
          {topics.map((topic) => (
            <button
              ...
              className={`block w-full text-left px-3 py-2 my-1 rounded-md transition-all ${
                activeTopic === topic ? "bg-blue-600" : "hover:bg-zinc-800"
              }`}
        ...
        <main className="w-full md:w-1/2 p-6 overflow-y-auto h-screen">
          <h1 className="text-2xl font-bold mb-4">{content[activeTopic]?.title}</h1>
          ...
          {content[activeTopic]?.sections.map((section) => (
            <a
              ...
              className={`block px-3 py-2 my-1 rounded-md transition-all ${
                activeSection === section.id ? "bg-blue-500 text-white" : "hover:bg-zinc-800"
              }`}
            >
              {section.title}
            </a>
